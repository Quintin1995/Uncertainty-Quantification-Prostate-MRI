...
#SBATCH --job-name=InfR3vSHARP
#SBATCH --cpus-per-task=8
#SBATCH --output=/scratch/hb-pca-rad/qvl/logs/job-%j_inference_vsharp_r3_1avg_v2.log
...
# PART 1 - 15 patients
direct predict /scratch/p290820/projects/03_nki_reader_study/output/umcg/3x \
    --cfg /scratch/p290820/projects/03_nki_reader_study/vsharp_r3.yaml \
