...
#SBATCH --output=/scratch/hb-pca-rad/projects/04_uncertainty_quantification/logs/uq_vsharp_R%a_%A_patset1.out
#SBATCH --error=/scratch/hb-pca-rad/projects/04_uncertainty_quantification/logs/uq_vsharp_R%a_%A_patset1.err
