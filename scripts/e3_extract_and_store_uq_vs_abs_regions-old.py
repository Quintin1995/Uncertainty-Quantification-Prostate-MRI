...
if __name__ == '__main__':
    ...
    # WARN THAT THIS SCRIPT IS DEPRECATED
    input("This script is deprecated. Please use the new version for processing uncertainty quantification data. Press Enter to continue...")
    # the newer version is called 'e4_extract_slice_uq_stats.py'
